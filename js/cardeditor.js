...
class PlaceholderCardArchetype extends CardArchetype {
...
exports.PlaceholderCardArchetype = PlaceholderCardArchetype;
...
class ActionCard extends Card {
    constructor(name, icon, type, effects) {
...
exports.PlaceholderEffect = PlaceholderEffect;
    ...
    return json.map((json_e) => {
        ...
        switch (json_e.type) {
            ...
            case "placeholder_hero_effect": {
                return new PlaceholderEffect('<span class="placeholder placeholder--heroEffect">do something</span> %to target%');
            }
            case "damage": {
                if (amount)
            ...
            case "discard_archetype": {
                return new he_DiscardArchetypeCard(effects, cardType, cardArchetype);
            }
            //Hero Passives
            case "placeholder_hero_passive": {
                return new PlaceholderEffect('<span class="placeholder placeholder--heroPassive">some passive effects</span>');
            }
            case "action": {
...
class he_DiscardArchetypeCard extends HeroEffect {
    constructor(effects, cardType, cardArchetype) {
        super();
        this.effects = effects;
        this.cardType = cardType;
        this.cardArchetype = cardArchetype;
